...
/**
 * The implementation of JSONNumber
 */
public class JSONNumberImpl extends JSONNumber implements IValueInstance
{
     ...
     */
    public JSONNumberImpl(Object value)
    {
        this.value = value;
    }
    ...
    /**
     * Compare this JSONNumber to another JSONNumber
     * @param jSONNumber  The JSONNumber to compare with
     * @return            A negative integer, zero, or a positive integer as
     *                    this JSONNumber is less than, equal to, or greater
     *                    than the specified JSONNumber
     */
    public int compareTo(JSONNumber jSONNumber)
    {
        return edma_domain.valueCompare(value, ((JSONNumberImpl) jSONNumber).value);
    }
