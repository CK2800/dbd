 ...
 */
public class ELEMENTImpl extends ELEMENT implements IValueInstance
{
    ...
    {
        return edma_domain.valueCompare(value, ((ELEMENTImpl) eLEMENT).value);
    }
    ...
    {
        return new ELEMENTKeyImpl(value[0]);
    }
    ...
    {
        return new ELEMENTValueImpl(value[1]);
    }
}
