...
/**
 * The implementation of JSONBoolean
 */
public class JSONBooleanImpl extends JSONBoolean implements IValueInstance
{
     ...
     */
    public JSONBooleanImpl(Object value)
    {
        this.value = value;
    }
    ...
    /**
     * Compare this JSONBoolean to another JSONBoolean
     * @param jSONBoolean  The JSONBoolean to compare with
     * @return             A negative integer, zero, or a positive integer as
     *                     this JSONBoolean is less than, equal to, or greater
     *                     than the specified JSONBoolean
     */
    public int compareTo(JSONBoolean jSONBoolean)
    {
        return edma_domain.valueCompare(value, ((JSONBooleanImpl) jSONBoolean).value);
    }
