...
/**
 * The implementation of ELEMENTKey
 */
public class ELEMENTKeyImpl extends ELEMENTKey implements IValueInstance
{
     ...
     */
    public ELEMENTKeyImpl(Object value)
    {
        this.value = value;
    }
    ...
    /**
     * Compare this ELEMENTKey to another ELEMENTKey
     * @param eLEMENTKey  The ELEMENTKey to compare with
     * @return            A negative integer, zero, or a positive integer as
     *                    this ELEMENTKey is less than, equal to, or greater
     *                    than the specified ELEMENTKey
     */
    public int compareTo(ELEMENTKey eLEMENTKey)
    {
        return edma_domain.valueCompare(value, ((ELEMENTKeyImpl) eLEMENTKey).value);
    }
