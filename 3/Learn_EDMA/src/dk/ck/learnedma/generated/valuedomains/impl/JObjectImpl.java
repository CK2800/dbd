...
/**
 * The implementation of JObject
 */
public class JObjectImpl extends JObject implements IValueInstance
{
    ...
    /**
     * Compare this JObject to another JObject
     * @param jObject  The JObject to compare with
     * @return         A negative integer, zero, or a positive integer as this
     *                 JObject is less than, equal to, or greater than the
     *                 specified JObject
     */
    public int compareTo(JObject jObject)
    {
        return edma_domain.valueCompare(value, ((JObjectImpl) jObject).value);
    }
    ...
    {
        return new ELEMENTSImpl(value[0]);
    }
}
