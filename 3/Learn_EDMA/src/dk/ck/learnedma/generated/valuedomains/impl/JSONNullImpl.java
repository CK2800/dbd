...
/**
 * The implementation of JSONNull
 */
public class JSONNullImpl extends JSONNull implements IValueInstance
{
     ...
     */
    public JSONNullImpl(Object value)
    {
        this.value = value;
    }
    ...
    /**
     * Compare this JSONNull to another JSONNull
     * @param jSONNull  The JSONNull to compare with
     * @return          A negative integer, zero, or a positive integer as this
     *                  JSONNull is less than, equal to, or greater than the
     *                  specified JSONNull
     */
    public int compareTo(JSONNull jSONNull)
    {
        return edma_domain.valueCompare(value, ((JSONNullImpl) jSONNull).value);
    }
