 ...
 */
public class OBJECTSImpl extends OBJECTS implements IValueInstance
{
    ...
    /**
     * Compare this OBJECTS to another OBJECTS
     * @param oBJECTS  The OBJECTS to compare with
     * @return         A negative integer, zero, or a positive integer as this
     *                 OBJECTS is less than, equal to, or greater than the
     *                 specified OBJECTS
     */
    public int compareTo(OBJECTS oBJECTS)
    {
        return edma_domain.valueCompare(value, ((OBJECTSImpl) oBJECTS).value);
    }
    ...
    {
        return new JObjectImpl(value[index]);
    }
     ...
     * 
     */
    public class OBJECTSIterator implements Iterator<JObject>
    {
        private int pos;
        ...
        public JObject next()
        {
            return new JObjectImpl(value[pos++]);
        }
