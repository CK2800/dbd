...
/**
 * The implementation of JSONString
 */
public class JSONStringImpl extends JSONString implements IValueInstance
{
     ...
     */
    public JSONStringImpl(Object value)
    {
        this.value = value;
    }
    ...
    /**
     * Compare this JSONString to another JSONString
     * @param jSONString  The JSONString to compare with
     * @return            A negative integer, zero, or a positive integer as
     *                    this JSONString is less than, equal to, or greater
     *                    than the specified JSONString
     */
    public int compareTo(JSONString jSONString)
    {
        return edma_domain.valueCompare(value, ((JSONStringImpl) jSONString).value);
    }
