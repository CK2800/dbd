...
/**
 * The implementation of MyInt
 */
public class MyIntImpl extends MyInt implements IValueInstance
{
    ...
    /**
     * Compare this MyInt to another MyInt
     * @param myInt  The MyInt to compare with
     * @return       A negative integer, zero, or a positive integer as this
     *               MyInt is less than, equal to, or greater than the specified
     *               MyInt
     */
    public int compareTo(MyInt myInt)
    {
        return edma_domain.valueCompare(value, ((MyIntImpl) myInt).value);
    }
