...
/**
 * The implementation of JSONFloat
 */
public class JSONFloatImpl extends JSONFloat implements IValueInstance
{
     ...
     */
    public JSONFloatImpl(Object value)
    {
        this.value = value;
    }
    ...
    /**
     * Compare this JSONFloat to another JSONFloat
     * @param jSONFloat  The JSONFloat to compare with
     * @return           A negative integer, zero, or a positive integer as
     *                   this JSONFloat is less than, equal to, or greater than
     *                   the specified JSONFloat
     */
    public int compareTo(JSONFloat jSONFloat)
    {
        return edma_domain.valueCompare(value, ((JSONFloatImpl) jSONFloat).value);
    }
